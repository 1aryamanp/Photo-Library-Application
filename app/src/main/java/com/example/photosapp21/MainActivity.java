package com.example.photosapp21;
/*
@author Deep Shah
...
import com.example.photosapp21.model.Album;
import com.example.photosapp21.model.Photo;
import com.example.photosapp21.model.User;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AutoCompleteTextView textView = (AutoCompleteTextView) findViewById(R.id.search_tag);
        List<String> tags = new ArrayList<>();
        for (Album album : User.getInstance().getAlbums()) {
            for (Photo photo : album.getPhotos()) {
                tags.addAll(photo.getPeople());
                if (!photo.getLocation().isEmpty()) {
                    tags.add(photo.getLocation());
                }
            }
        }
